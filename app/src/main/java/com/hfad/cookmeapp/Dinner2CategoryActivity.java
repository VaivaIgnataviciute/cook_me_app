...
public class Dinner2CategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinner2_category);
...
//I am creating on click listeners for list_dinner2,
        ListView list_dinner2 = findViewById(R.id.list_dinner2);
        ...
        try {
            ...
            cursor = db.query("BREAKFAST",
                    new String[]{"_id", "NAME"},
                    "NAME=?",
                    new String[]{"Beef burger"}, null, null, null);
            ...
            list_dinner2.setAdapter(listAdapter);
